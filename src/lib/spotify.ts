...
interface Track {
  id: string;
  [key: string]: any; // Assuming track has other properties
}
...
export default function Genre({ genre, tracks }: GenreProps) {
  return (
...
export async function getStaticPaths() {
  ...
  const genrePaths = data.genres.map((genre: string) => ({ params: { genre } }));
